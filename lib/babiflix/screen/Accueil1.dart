                ...
                Expanded(
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: CarouselSlider.builder(
                          ...
                          decoration: BoxDecoration(
                             image: DecorationImage(image: AssetImage("images/esse.jpg"), fit: BoxFit.cover),
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Column(
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                      child: FittedBox(
                                        child: Text("Marvel's The Defenders",
                                        style: TextStyle(
                                          color: Colors.white,
                                          fontWeight: FontWeight.bold,
                                          fontSize: 15
                    ...
                    Padding(
                     ...
                     child: Container(
                      ...
                      padding: const EdgeInsets.all(10),
                      child: Container(
                        child: Text("Explorer par categeorie",
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 18,
                          fontWeight: FontWeight.bold
